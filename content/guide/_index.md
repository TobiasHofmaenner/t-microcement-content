...
The polymer modification gives it some flex, so normal building
...
- **Scratch or chip** → trowel a thin layer over the area, blend the
  edges, re-seal. The new layer bonds chemically to the old.
- **Whole-room refresh after a few years** → light sand, re-seal,
  looks new.
