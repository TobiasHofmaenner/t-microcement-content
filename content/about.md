---
title: "About"
description: "Where T-Microcement comes from."
---

# Where this comes from

T-Microcement started on a project in **Medewi, West Bali**.

We were building a villa from scratch and wanted a seamless, modern
finish throughout. We tested the microcement systems on the local
market: the ones that looked right cost a fortune for a whole house,
and the affordable ones didn't perform. The gap between *good enough*
and *affordable* was too wide to live with.

So we started experimenting.

## Months of iterating

A dozen components, a long series of prototypes, test patches on the
build, and a lot of *"this works in our test but local contractors
can't repeat it."*

The hard part turned out not to be the finished properties. It was
making the system **workable by people who hadn't seen it before**,
**hard to mess up**, and **built from ingredients you can actually
source in Indonesia**.

The final mix is a polymer-modified white cement with mineral
